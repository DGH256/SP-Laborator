...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        OpenCommand openCommand = new OpenCommand("Titlu carte 11");
        openCommand.execute();

        Section newSection = new Section("Sectiune 22");
        newSection.add(new Paragraph("Paragraf 33"));
        ...
        FileIOHandler.writeToFile(jsonOutput, "output.txt");
